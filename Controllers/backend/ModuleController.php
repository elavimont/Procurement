...
class ModuleController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($module) {
            ...
            return redirect()->route('module.create')->with('error_message', 'You con not create right now');
        }
    }
    /**
    ...
    public function destroy($id)
    {
        ...
        if ($check) {
            ...
            if ($message) {
                ...
                return redirect()->route('module.update')->with('error_message', 'failed to delete');
            }
        }
    }
}

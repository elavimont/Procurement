...
class UserController extends Controller
{
    ...
    public function login(Request $request)
    {
        ...
        if (Auth::attempt(['username' => $request->username, 'password' => $request->password])) {
            ...
            Auth::user()->save();
            return redirect()->route('user.dashboard')->with('success_message', 'You are successfully logged in');
        } else {
    ...
    public function changesave(Request $request)
    {
        ...
        if (Hash::check($request->oldpassword, $user->password)) {
            ...
            $user->update();
            return redirect()->back()->with('success_message', 'Successfully changed your password');
        } else {
